...
def load_enabled_spells():
    with open('HomebrewSpells_enabled.txt', 'r') as fd:
...
if __name__ == "__main__":
    ...
    with open('SecretScrollsHomebrewSpells.xml', 'w+') as localization, \
         open('Object_SecretScrollsHomebrewSpells.txt', 'w+') as objects:
